...
## Current run (files present)

Files generated by the latest pipeline run are present under `part1/output/` (examples):

- `part1/output/raw/master_raw_data.csv` (≈ 982k rows)
- `part1/output/cleaned/cleaned_data.csv` (≈ 90.5k rows)
- `part1/output/transformed/transformed_data.csv` (≈ 90.5k rows)
- `part1/output/failed/failed_data.csv` (≈ 891k rows)
- `part1/output/hashed/hashed_data_anonymized.csv` (≈ 90.5k rows)
